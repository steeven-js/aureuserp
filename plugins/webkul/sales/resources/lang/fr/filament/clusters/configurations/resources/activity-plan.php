...
return [
    ...
    'table' => [
        ...
        'actions' => [
            'restore' => [
                'notification' => [
                    'title' => 'Plan d\'activités restauré',
                    'body'  => 'Le plan d\'activités a été restauré avec succès.',
                ],
            ],

            'delete' => [
                'notification' => [
                    'title' => 'Plan d\'activités supprimé',
                    'body'  => 'Le plan d\'activités a été supprimé avec succès.',
                ],
            ],

            'force-delete' => [
                'notification' => [
                    'title' => 'Plan d\'activités supprimé définitivement',
                    'body'  => 'Le plan d\'activités a été supprimé définitivement avec succès.',
                ],
            ],
        ],
        ...
        'empty-state' => [
            'create' => [
                'notification' => [
                    'title' => 'Plan d\'activités créé',
                    'body'  => 'Le plan d\'activités a été créé avec succès.',
                ],
            ],
        ],
    ],
